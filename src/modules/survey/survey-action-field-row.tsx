...
/**
 * survey-action-field-row.tsx
 * Common key / type / value / AI-field input row for actions.
 * No API calls.
 */
...
import { AGENT_ACTION_FIELD_TYPES } from "./survey-action-constants";

export interface AgentActionFieldRowProps {
    ...
    <div className="grid grid-cols-12 items-center gap-2 rounded-[6px] border border-border/40 bg-muted/20 p-2 sm:gap-3 sm:p-3">
      ...
      <div className="col-span-6 sm:col-span-2">
        ...
        <Select
          ...
          options={AGENT_ACTION_FIELD_TYPES}
