...
/**
 * survey-saved-actions-panel.tsx
 * Sidebar list of saved actions.
 * No API calls.
 */
...
export interface AgentSavedActionsPanelProps {
  actions: AgentAction[];
  onDelete: (id: string) => void;
}

export function AgentSavedActionsPanel({
  actions,
  onDelete,
}: AgentSavedActionsPanelProps) {
  return (
