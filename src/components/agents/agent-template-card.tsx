...
export function AgentTemplateCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-border/50 bg-card/90 shadow-card backdrop-blur-sm transition-all duration-300 group-hover:border-primary/25 group-hover:shadow-elevated">
        <div
          className={cn(
        ...
        >
          <div className="flex items-start gap-3">
            <div
              className="flex size-11 shrink-0 items-center justify-center rounded-xl border border-white/20 bg-white/15 shadow-inner backdrop-blur-md"
              style={
                template.accent
